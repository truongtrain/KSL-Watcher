...
class SearchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create search" do
    assert_difference('Search.count') do
      post searches_url, params: { search: { keywords: @search.keywords, user_id: @search.user_id } }
    end
  ...
  test "should update search" do
    patch search_url(@search), params: { search: { keywords: @search.keywords, user_id: @search.user_id } }
